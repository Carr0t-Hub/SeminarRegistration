...
if (!isset($_GET['seminarID'])) {
  ...
  $title = getTitle($mysqli, $_GET['seminarID']);
?>
              ...
              <div class="text-center">
                <div class="row align-items-start">
                  <div class="col">
                    ...
                    <input type="text" hidden class="form-control" id="seminarID" name="seminarID" value="<?= $_GET['seminarID']?>">
                  </div>
                  <div class="col">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show active" id="home">
                ...
                <div class="col-md-12 mb-12">
                  <label for="pwd" class="form-label">Do you want to create an Account? <span class="text-danger">*</span></label>
